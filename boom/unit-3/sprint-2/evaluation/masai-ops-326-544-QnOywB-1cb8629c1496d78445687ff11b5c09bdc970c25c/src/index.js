...
let outputArray=inputArray.map((e,i)=>{
let obj={};
obj["productId"]=e.idMeal;
obj["productTitle"]=e.strMeal;
obj["Category"]="Dessert";
obj["Area"]=areasDirectory[e.Area];
obj["Ingredients"]=[];

for(let a=1;a<=20;a++){
  
  e[`strIngredient${a}`] && obj["Ingredients"].push({ingredient:e[`strIngredient${a}`], measure: e[`strMeasure${a}`]});
