...
function App() {
  ...
  return (
    ...
    {arr5}
      <Button></Button>
      <Avatar src="https://media.istockphoto.com/id/1332414584/vector/baphomet-pentagramv.jpg?s=612x612&w=0&k=20&c=ZJDxK7ZWaspqwy01nscBo7fgZ5bp57VUqvHHiLexYkQ=" width="200px" name="Illuminat" rounded={true}></Avatar>
    </div>
  );
}
