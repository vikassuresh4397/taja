...
data.map(({ submission_link: link, id }) => {
  describe("RCT-201-B20-E1 Evaluation", () => {
    ...
    it("first and previous button should be disabled on page 1", () => {
      //for 2 marks
      cy.get("[data-cy=product]").should("exist");
      cy.get("[data-cy=pagination-first-button]").should("exist");
    ...
    it("last and next button should be disabled on last page", () => {
      //for 2 marks
      cy.get("[data-cy=product]").should("exist");
    ...
    it("should be able to make a request and get the data successfully on load ", () => {
    ...
    it(`page limit drop down should work and get the data as per the limit
