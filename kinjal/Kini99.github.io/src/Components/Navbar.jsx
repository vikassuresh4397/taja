      ...
      <div className='navbar'>
        ...
        {isOpen ? <Menu>
          ...
          <MenuList sx={{ zIndex: "100", backgroundColor: "#A2A6FF", paddingTop: "5px" }}>
            ...
            <MenuItem style={{ border: "none", color: "black", marginLeft: "15px", paddingBottom: "10px", backgroundColor: "transparent" }} 
            onClick={() => window.open("https://drive.google.com/file/d/1Iv46uAZkxIfhftVBNBiJrc-GbB3d0F2C/view?usp=share_link")} id="resume-button-1" >
