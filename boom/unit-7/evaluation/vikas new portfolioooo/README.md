...
Maximum Marks - 34
 ...
 ✅ Navbar is linked to the following sections: About, Skills, Projects, Contact, Home - 1 mark each (5 marks total)
...
For Resume Button, if you're using anchor tag, using it with onClick() function will fail the test case. DO NOT USE ONCLICK() ON ANCHOR TAG
All the Resume button present in the Portfolio should have the same function [ All have either anchor or EventListener ]
Portfolio should only contain static element. [ No gifs or any dynamic element ] { This is a Testing Limitation }
